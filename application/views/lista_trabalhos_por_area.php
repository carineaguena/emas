...
<html lang="pt-br">
    <head>
        <title>Lista de trabalhos submetidos por área - Versão para impressão</title>
    ...
    <body>
        ...
        <p style="text-align: center; font-size: 18px; font-weight: bold;">Lista de trabalhos submetidos por área</p>
                ...
                <?php
                    if(isset($trabalhos)) {
                        ...
                        foreach($trabalhos as $trabalho) {
                            if($area != $trabalho->area) {
                                $area = $trabalho->area;

                                echo '
                                    <tr>
                                        <td colspan="7" style="font-weight: bold; text-align: center;"><big>' . $area . '</big></td>
                                    </tr>
                                ';
                            }

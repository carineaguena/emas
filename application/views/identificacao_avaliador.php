            ...
            <div class="row" style="margin-top: 17px;">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    ?>
                    <form role="form" method="post" action="<?php echo base_url();?>avaliacao/login/autenticar">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary">Enviar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-link" href="<?php echo base_url();?>avaliacao/login/esquecisenha">Esqueci minha senha...</a>
                            </div>
                        </fieldset>
                    </form>
                </div>
